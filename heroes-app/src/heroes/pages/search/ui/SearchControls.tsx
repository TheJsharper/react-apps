        ...
        <>
            ...
            <div className="flex flex-col lg:flex-row gap-4 mb-8">
                ...
                <div className="relative flex-1">
                    ...
                    <Search className="absolute left-3 top-1/2 transform -translate-y-3" />
                    <Input placeholder="Search heroes, villains, power, teams ...." className="pl-12 h-12 text-lg" />
                ...
                <div className="flex gap-2">
                    ...
                    <Button variant="outline" className="h-12 bg-transparent">
                        <SortAsc className="h-4 w-4 mr-2" />Sort by name
                    </Button>
