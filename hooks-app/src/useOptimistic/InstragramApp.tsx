...
export const InstagromApp = () => {
    ...
    const [optimisticComments, addOptimisticComment] = useOptimistic(comments,
        ...
        (state: Comment[], newCommentText: string) => {
            ...
            return [...state, { id: new Date().getTime(), text: newCommentText, optimistic: true }];
        }
    )
    ...
    const handleAddComment = async (formData: FormData) => {
        ...
        startTransittion(async () => {
            const nextCall = Math.ceil(Math.random() * 10);
            ...
            if (nextCall % 2 == 0) {
                ...
                console.log("Message stored", nextCall)
            } else {

                setComments(prev => prev)
                console.error("Message stored failed", nextCall)
                toast('Errror by logging your comment ', {
