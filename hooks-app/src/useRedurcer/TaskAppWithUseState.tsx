...
export const TasksAppWithUseState = () => {
  ...
  const toggleTodo = (id: number) => {
    const updateTodos = todos.map((value: Todo) => value.id == id ? ({ ...value, completed: !value.completed }) : ({ ...value }));
    setTodos([...updateTodos])

  };

  const deleteTodo = (id: number) => {
    const updateTodos = todos.filter((value: Todo) => value.id !== id);
    setTodos(() => [...updateTodos])
